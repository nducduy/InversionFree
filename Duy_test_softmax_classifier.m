function  Duy_test_softmax_classifier()
    ...
    if 0
        ...
        algorithms = {'SGD','AdaGrad','oBFGS-Lim','IQN'};
        %algorithms = {'SGD','IQN','oBFGS-Inf','Reg-oBFGS-Inf','oBFGS-Lim'}; 
    end      
