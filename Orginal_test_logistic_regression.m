function  Orginal_test_logistic_regression()
    ...
    if 0
        ...
        %algorithms = {'SGD','SVRG','SVRG-LBFGS','IQN','SQN'};  
        algorithms = {'SGD','AdaGrad','SAGA','oBFGS-Lim','IQN','SQN'};
    end       
    ...
    for alg_idx=1:length(algorithms)
        ...
        switch algorithms{alg_idx}
            ...
            case {'SGD'} 
                ...
                %options.step_init = 0.0001 * options.batch_size; %Excellent step size
